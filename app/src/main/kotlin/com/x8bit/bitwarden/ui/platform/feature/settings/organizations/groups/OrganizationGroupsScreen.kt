...
fun OrganizationGroupsScreen(
    ...
    when (val dialog = state.dialogState) {
        ...
        is OrganizationGroupsState.DialogState.ConfirmDelete -> {
            BitwardenTwoButtonDialog(
                ...
                onConfirmClick = {
                    viewModel.trySendAction(OrganizationGroupsAction.ConfirmDeleteGroup(dialog.groupId))
                },
                onDismissClick = { viewModel.trySendAction(OrganizationGroupsAction.DismissDialog) },
                onDismissRequest = { viewModel.trySendAction(OrganizationGroupsAction.DismissDialog) },
            )
        }
        null -> Unit
    ...
    BitwardenScaffold(
        ...
        when (val viewState = state.viewState) {
            ...
            is OrganizationGroupsState.ViewState.Error -> {
                Column(
                    modifier = Modifier
                        .fillMaxSize()
                        .padding(16.dp),
                    ...
                    BitwardenOutlinedButton(
                        ...
                        onClick = { viewModel.trySendAction(OrganizationGroupsAction.RetryClick) },
                    )
                }
            }
        }
